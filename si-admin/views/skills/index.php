  ...
  <body>
    ...
    $(document).ready(function() {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Add"){
                ...
                $.ajax({
                    url:"http://localhost/web_porto/si-admin/api/skills/create.php",
                    method:"POST",
                ...
                $.ajax({
                    url:"http://localhost/web_porto/si-admin/api/skills/update.php",
                    method:"PUT",
                    data: JSON.stringify(formData),
                    success:function(data){
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url:"http://localhost/web_porto/si-admin/api/skills/read.php",
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            url:
            "http://localhost/web_porto/si-admin/api/skills/read.php?id="+id,
            success: function(response) {
                $('#id').val(response.id);
    ...
    function deleteOne(id) {
      ...
      if (konfirmasiUser) {
        $.ajax({
            url:"http://localhost/web_porto/si-admin/api/skills/delete.php",
            method:"DELETE",
